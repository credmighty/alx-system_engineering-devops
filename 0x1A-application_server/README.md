...
- [Be careful with the way Flask manages slash](https://werkzeug.palletsprojects.com/en/stable/ "Be careful with the way Flask manages slash") in [route](https://flask.palletsprojects.com/en/stable/api/#flask.Blueprint.route "route") - `strict_slashes`
